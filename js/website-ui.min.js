...
angular.module("ui.website.chart",[]).service("ChartService",[function(){var e={pline:{chart:{type:"spline",margin:[30,20,65,20]},title:{text:""},subtitle:{text:""},xAxis:{gridLineWidth:0,categories:[],lineColor:"#bababa",type:"datetime",tickmarkPlacement:"on",labels:{style:{fontSize:"14px"},y:20}},yAxis:{title:{text:"",style:{color:"#bababa",fontSize:"14px"}},lineColor:"#bababa",labels:{enabled:!1,style:{fontSize:"14px"}},plotLines:[{value:0,width:0,color:"#808080"}],tickPixelInterval:30,lineWidth:0,tickWidth:0,gridLineColor:"#efefef"},tooltip:{shared:!0,valueSuffix:"",borderWidth:1,borderColor:"#8b8b8b",useHTML:!0,crosshairs:{width:1,color:"gray",dashStyle:"shortdot"},formatter:function(){return""}},plotOptions:{line:{dataLabels:{enabled:!1},enableMouseTracking:!0,lineColor:"#47a6ff"},series:{marker:{symbol:"circle"}}},legend:{layout:"horizontal",align:"center",verticalAlign:"bottom",borderWidth:0},credits:{enabled:!1},series:[{name:"",data:[]}]}},t={bar:{title:{x:"center"},tooltip:{borderWidth:1,borderColor:"#8b8b8b",backgroundColor:"#ffffff",textStyle:{color:"#333333"},trigger:"item",formatter:"{b} : {c}%"},calculable:!1,grid:{borderWidth:0,x:"3%",y:20,y2:50,width:"94%"},xAxis:[{show:!0,type:"category",data:[],splitLine:{show:!0,lineStyle:{color:"white",width:10}},axisLabel:{show:!0,interval:"0",margin:15},axisLine:{show:!0,lineStyle:{color:"#d2d2d2",width:1}},axisTick:{onGap:null,lineStyle:{color:"#d2d2d2"}}}],yAxis:[{type:"value",show:!1}],series:[]},pie:{legend:{orient:"horizontal",y:"bottom",data:[]},tooltip:{trigger:"item",borderWidth:1,borderColor:"#8b8b8b",backgroundColor:"#ffffff",textStyle:{color:"#333333"},formatter:function(e){var t=e.name+": "+Number(e.percent).toFixed(1)+"%";return t}},calculable:!1,series:[{name:"",type:"pie",center:["50%","45%"],radius:["50","80"],itemStyle:{normal:{label:{show:!1},labelLine:{show:!1}},emphasis:{label:{show:!0,position:"center",textStyle:{fontSize:"30",fontWeight:"bold"}}}},data:[]}]}};return{getInstance:function(r,a,o){if(a){if(t.hasOwnProperty(a))return echarts.init(r);if(e.hasOwnProperty(a))return highcharts.init(r)}else{if("echarts"==o)return echarts.init(r);if("highcharts"==o)return highcharts.init(r)}},getOption:function(e,r,a){if(!e)return r;var o=t[e],i=r.data,l=r.category,n=[],h=[];if("bar"==e){for(var c=0;c<i.length;c++){for(var s=i[c],d=[],f={name:"",type:"bar",barWidth:30,data:[]},b=0;b<s.length;b++){var p={name:l[b],data:s[b]};d.push(p)}var u=d.concat();u.sort(function(e,t){return Number(t.data)-Number(e.data)});for(var b=0;b<u.length;b++)u[b].color=a.color[b%a.color.length];for(var b=0;b<d.length;b++){var g={value:d[b].data,name:d[b].name,itemStyle:{normal:{color:d[b].color,label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}},labelLine:{show:!1}},emphasis:{label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}}}}};n.push(g)}f.data=n,h.push(f)}return o.series=h,o.xAxis[0].data=r.category,o}if("pie"==e)for(var c=0;c<i.length;c++){var y=i[c];if(!y||y.length!=l.length)throw new Error("Data error, check your data please");for(var b=0;b<l.length;b++){var g={name:l[b],value:i[c][b],itemStyle:{normal:{color:a.color[b%a.color.length]},emphasis:{label:{show:!1}}}};n.push(g)}return o.series[c].data=n,o.legend.data=r.category,o}}}}]).directive("chart",["ChartService",function(e){var t={showLoading:!0,order:!0,limit:10,noDataTemplateUrl:"templates/echarts/no-data.html"},r={bar:{color:["#03a7e5","#03a7e5","#1db5ee","#1db5ee","#42ccff","#42ccff","#7ddcff","#7ddcff","#a6e7ff","#a6e7ff","#a6e7ff"],orientation:"horizontal"},pie:{color:["#42ccff","#fbd444"]}};return{restrict:"A",scope:{chart:"@",config:"@",data:"=",chartStyle:"@"},templateUrl:"website-ui/chart/no-data.html",replace:!1,compile:function(a,o){return function(a,o,i,l){var n=window.getComputedStyle(o[0]),h=n.getPropertyValue("height");"0px"==h&&o.css({height:"200px"});var c={},s={};try{a.config&&(c=JSON.parse(a.config)),a.chartStyle&&(s=JSON.parse(a.chartStyle))}catch(d){}var f,b=angular.extend({},t,c),p=r[a.chart],u=angular.extend({},p,s);i.hasOwnProperty("echarts")?f="echarts":i.hasOwnProperty("highcharts")&&(f="highcharts");var g=o.find("div").find("div")[0],y=e.getInstance(g,a.chart,f);b.showLoading&&y.showLoading(),a.$watch("data",function(t,r){if(t)try{var o=e.getOption(a.chart,t,u);y.hideLoading(),y.setOption(o),a.noData=!1}catch(i){console.error(i.message),y.hideLoading(),a.noData=!0}})}}}}]).run(["$templateCache",function(e){var t=[];t.push('<div style="position: relative;height: 100%;">'),t.push('<div style="height: 100%; width: 100%;">'),t.push("</div>"),t.push('<div ng-if="noData" style="height: 100%; width: 100%; position: absolute; left: 0;top: 0;;">暂无数据</div></div>'),e.put("website-ui/chart/no-data.html",t.join(""))}]);