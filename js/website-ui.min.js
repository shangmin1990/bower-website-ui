...
angular.module("ui.website.dialog.directives",[]).directive("walert",["$timeout",function(n){return{restrict:"EA",transclude:!0,templateUrl:"partial/alert.html",compile:function(i,t,l){function d(){i.children().removeClass("in"),n(function(){i.hide()},150)}return i.show(),{pre:angular.noop,post:function(i,t,l,c){t.find("div.modal-footer").find("button").unbind("click").bind("click",function(n){d()}),t.find("button.close").unbind("click").bind("click",function(n){d()}),n(function(){t.children().addClass("in")},0)}}}}}]).directive("wconfirm",["$timeout",function(n){return{restrict:"EA",transclude:!0,templateUrl:"partial/confirm.html",compile:function(i,t,l){function d(){i.children().removeClass("in"),n(function(){i.hide()},150)}return i.show(),{pre:angular.noop,post:function(i,t,l,c){var o=t.find("div.modal-footer").find("button");angular.element(o[0]).unbind("click").bind("click",function(n){i.ok(),d()}),angular.element(o[1]).unbind("click").bind("click",function(n){d()}),t.find("button.close").unbind("click").bind("click",function(n){d()}),n(function(){t.children().addClass("in")},0)}}}}}]).directive("wprompt",["$timeout",function(n){return{restrict:"EA",transclude:!0,templateUrl:"partial/confirm.html",compile:function(i,t,l){function d(i,t,l,d){var o=t.find("div.modal-footer").find("button");angular.element(o[0]).unbind("click").bind("click",function(n){var l=i.callback(t.find("input").val());"boolean"==typeof l&&l||1===l?c():t.find("input").parent().addClass("has-error").addClass("has-feedback")}),angular.element(o[1]).unbind("click").bind("click",function(n){c()}),t.find("button.close").unbind("click").bind("click",function(n){c()}),n(function(){t.children().addClass("in")},0)}function c(){i.children().removeClass("in"),n(function(){i.hide()},150)}return i.show(),d}}}]).run(["$templateCache",function(n){n.put("template/alert.html",'<div class="modal fade" style="display:block;"><div class="modal-dialog modal-sm"><div class="modal-content"><div class="modal-header"><div class="row"><div class="col-md-9 col-lg-9">{{title}}</div><div class="col-md-3 col-lg-3"><button type="button" class="close"><span>×</span></button></div></div></div><div class="modal-body text-center"><p><div ng-transclude></div></p></div><div class="modal-footer"><button type="button" class="btn btn-orz">确定</button></div></div></div></div><div class="modal-backdrop fade"></div>'),n.put("template/confirm.html",'<div class="modal fade" style="display:block;"><div class="modal-dialog modal-sm"><div class="modal-content"><div class="modal-header"><div class="row"><div class="col-md-9 col-lg-9">{{title}}</div><div class="col-md-3 col-lg-3"><button type="button" class="close"><span>×</span></button></div></div></div><div class="modal-body text-center"><p><div ng-transclude></div></p></div><div class="modal-footer"> <button type="button" class="btn btn-orz">是</button> <button type="button" class="btn btn-default btn-large" >否</button></div></div></div></div><div class="modal-backdrop fade"></div>')}]);
angular.module("ui.website.dialog.service",[]).factory("DialogService",["$document","$compile","$rootScope",function(t,e,n){return{alert:function(l,r){var i=t.find("walert");0==i.length?(i=angular.element('<walert title="'+r+'">'+l+"</walert>"),t.find("body").append(i)):i.html(l);var a=n.$new(!1);r||(r="警告"),a.title=r,e(i)(a)},confirm:function(l,r,i){var a=t.find("wconfirm");0==a.length?(a=angular.element('<wconfirm title="'+i+'" >'+l+"</wconfirm>"),t.find("body").append(a)):(a.html(l),a.data("success",r));var o=n.$new(!1);i||(i="请确认"),o.title=i,o.ok=r,e(a)(o)},prompt:function(l,r){var i=t.find("wprompt");0==i.length?(i=angular.element('<wprompt title="'+r+'"><input type="text" class="form-control" style="width: 70%; margin-left: 15%"/></wprompt>'),t.find("body").append(i)):i.html('<input type="text" class="form-control" style="width: 70%; margin-left: 15%"/>');var a=n.$new(!1);r||(r="请输入"),a.title=r,a.callback=l,e(i)(a)}}}]);