...
angular.module("ui.website.select.directives",["ui.bootstrap.position"]).directive("wsSelect",["$compile","$document","$uibPosition","$timeout",function(e,i,t,a){return{restrict:"EA",replace:!0,templateUrl:"template/wsSelect.html",require:["ngModel"],scope:{options:"=",onSelected:"&",config:"@"},compile:function(t,n,o){return{pre:angular.noop,post:function(t,n,o,l){var c=l[0];t.config=t.config||{},t.config.displayFieldName=t.config.displayFieldName||"key",t.config.valueFieldName=t.config.valueFieldName||"value";var r=uuid(),s=angular.element("<div ws-select-container></div>");s.attr({id:r});var d=e(s)(t);n.append(d),$(n).bind("click",function(e){e.stopPropagation();var i=d.find("li");if(i){var t=c.$modelValue;i.removeClass("active"),angular.forEach(i,function(e,i){$(e).attr("value")===t&&$(e).addClass("active")})}d.show()}),i.bind("click",function(e){d.hide()}),t.$watch("options",function(e){if(e&&e.length>0){var i=c.$modelValue;i&&angular.forEach(e,function(e){e[t.config.valueFieldName]===i&&n.find("div").html(e[t.config.displayFieldName])}),a(function(){var e=d.find("li");e.bind("click",function(i){i.stopPropagation();var a=this;e.removeClass("active"),$(a).addClass("active"),d.hide(),d.css("display","none");var o=$(a).find("a").html();n.find("div").html(o),c.$setViewValue($(a).attr("value")),t.onSelected(o,i)}),e.bind("mouseenter",function(i){var t=this;e.removeClass("active"),$(t).addClass("active")})},0)}},!0)}}}}}]).directive("wsSelectContainer",[function(){return{restrict:"EA",replace:!0,templateUrl:"template/wsSelectContainer.html"}}]).run(["$templateCache",function(e){var i=[];i.push('<div style="position: relative;"><div style="border-radius: 4px" class="form-control" ></div><i class="fa fa-sort" style="position: absolute;right: 5px;top: 0px;height: 100%;padding-top: 10px; transform: scaleX(0.8)"></i></div>'),e.put("template/wsSelect.html",i.join("")),e.put("template/wsSelectContainer.html",'<ul class="dropdown-menu" style=\'min-height:100px;max-width: 400px;max-height: 400px;overflow-y: scroll;box-shadow: 0 6px 12px rgba(0,0,0,.175);border: 1px solid #ccc;\'>\n    <li class="ws-select-option" value=\'{{option[config.valueFieldName]}}\' ng-repeat="option in options track by $index" ng-click="onSelected(option.value, $event)" role="option" >\n        <a >{{option[config.displayFieldName]}}</a>    </li>\n</ul>\n')}]);