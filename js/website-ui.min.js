...
angular.module("ui.website.chart",[]).service("ChartService",[function(){var e={pline:{chart:{type:"spline",margin:[30,20,65,20]},title:{text:""},subtitle:{text:""},xAxis:{gridLineWidth:0,categories:[],lineColor:"#bababa",type:"datetime",tickmarkPlacement:"on",labels:{style:{fontSize:"14px"},y:20}},yAxis:{title:{text:"",style:{color:"#bababa",fontSize:"14px"}},lineColor:"#bababa",labels:{enabled:!1,style:{fontSize:"14px"}},plotLines:[{value:0,width:0,color:"#808080"}],tickPixelInterval:30,lineWidth:0,tickWidth:0,gridLineColor:"#efefef"},tooltip:{shared:!0,valueSuffix:"",borderWidth:1,borderColor:"#8b8b8b",useHTML:!0,crosshairs:{width:1,color:"gray",dashStyle:"shortdot"},formatter:function(){return""}},plotOptions:{line:{dataLabels:{enabled:!1},enableMouseTracking:!0,lineColor:"#47a6ff"},series:{marker:{symbol:"circle"}}},legend:{layout:"horizontal",align:"center",verticalAlign:"bottom",borderWidth:0},credits:{enabled:!1},series:[{name:"",data:[]}]}},t={line:{title:{text:""},tooltip:{trigger:"axis"},legend:{data:[]},toolbox:{show:!1},grid:{left:"3%",right:"4%",bottom:"3%",containLabel:!0},xAxis:[{type:"category",boundaryGap:!1,data:[]}],yAxis:[{type:"value"}],series:[]},bar:{title:{x:"center"},tooltip:{borderWidth:1,borderColor:"#8b8b8b",backgroundColor:"#ffffff",textStyle:{color:"#333333"},trigger:"item",formatter:"{b} : {c}%"},calculable:!1,grid:{borderWidth:0,x:"3%",y:20,y2:50,width:"94%"},xAxis:[{show:!0,type:"category",data:[],splitLine:{show:!0,lineStyle:{color:"white",width:10}},axisLabel:{show:!0,interval:"0",margin:15},axisLine:{show:!0,lineStyle:{color:"#d2d2d2",width:1}},axisTick:{onGap:null,lineStyle:{color:"#d2d2d2"}}}],yAxis:[{type:"value",show:!1}],series:[]},pie:{legend:{orient:"horizontal",y:"bottom",data:[]},tooltip:{trigger:"item",borderWidth:1,borderColor:"#8b8b8b",backgroundColor:"#ffffff",textStyle:{color:"#333333"},formatter:function(e){var t=e.name+": "+Number(e.percent).toFixed(1)+"%";return t}},calculable:!1,series:[{name:"",type:"pie",itemStyle:{normal:{label:{show:!1},labelLine:{show:!1}},emphasis:{label:{show:!0,position:"center",textStyle:{fontSize:"30",fontWeight:"bold"}}}},data:[]}]}};return{getInstance:function(r,a,o){if(a){if(t.hasOwnProperty(a))return echarts.init(r);if(e.hasOwnProperty(a))return highcharts.init(r)}else{if("echarts"==o)return echarts.init(r);if("highcharts"==o)return $(r).highcharts()}},getOption:function(e,r,a,o,i){if(!e)return r;var l=angular.copy(t[e]);o()&&(l.tooltip.formatter=o());var n=r.data,s=r.category;i.limit>0&&s.length>i.limit&&(s=s.slice(0,i.limit));var h=[];if("bar"==e){for(var c=0;c<n.length;c++){var d=[],g=n[c],p=[],u={name:"",type:e,barWidth:30,data:[]};i.limit>0&&s.length>i.limit&&(g=g.slice(0,i.limit));for(var f=0;f<g.length;f++){var m={name:s[f],data:g[f]};p.push(m)}var b=i&&i.sortForColor,y=a&&a.color&&a.color.length>=n.length&&a.color[0].length>=g.length;if(b&&y){var v=p.concat();v.sort(function(e,t){return Number(t.data)-Number(e.data)});for(var f=0;f<v.length;f++)v[f].color=a.color[c][f]}for(var f=0;f<p.length;f++){var x={value:p[f].data,name:p[f].name,itemStyle:{normal:{label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}},labelLine:{show:!1}},emphasis:{label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}}}}};p[f].color&&(x.itemStyle.normal.color=p[f].color),d.push(x)}u.data=d,h.push(u)}if(l.series=h,l.xAxis[0].data=r.category,"vertical"===a.orientation){var w=l.yAxis;l.yAxis=xAxis,l.xAxis=w}return l}if("line"==e){for(var c=0;c<n.length;c++){for(var d=[],g=n[c],p=[],u={name:"",type:e,data:[]},f=0;f<g.length;f++){var m={name:s[f],data:g[f]};p.push(m)}for(var f=0;f<p.length;f++){var x={value:p[f].data,name:p[f].name};d.push(x)}if(a&&a.color&&a.color.length>=n.length){var S={normal:{color:a.color[c]}};u.lineStyle=S}u.data=d,h.push(u)}return l.series=h,l.xAxis[0].data=r.category,l}if("pie"==e)for(var c=0;c<n.length;c++){var d=[],L=n[c];if(!L||L.length!=s.length)throw new Error("Data error, check your data please");for(var f=0;f<s.length;f++){var x={name:s[f],value:n[c][f],itemStyle:{normal:{},emphasis:{label:{show:!1}}}};a.color&&a.color.length>=n.length&&a.color[0].length>=s.length&&(x.itemStyle.normal.color=a.color[c][f]),d.push(x)}return l.series[c].data=d,l.legend.data=r.category,a&&a.center&&a.center.length>=n.length&&(l.series[c].center=a.center[c]),a&&a.radius&&a.radius.length>=n.length&&(l.series[c].radius=a.radius[c]),l}}}}]).directive("chart",["ChartService",function(e){var t={showLoading:!0,sortForColor:!1,limit:-1,noDataTemplateUrl:"templates/echarts/no-data.html"},r={bar:{orientation:"horizontal"},pie:{}};return{restrict:"A",scope:{chart:"@",config:"@",data:"=",eventType:"@",eventHandler:"&",chartStyle:"@",tooltipFormatter:"&"},templateUrl:"website-ui/chart/no-data.html",replace:!1,compile:function(a,o){return function(a,o,i,l){var n=window.getComputedStyle(o[0]),s=n.getPropertyValue("height");"0px"==s&&o.css({height:"200px"});var h={},c={};try{a.config&&(h=JSON.parse(a.config)),a.chartStyle&&(c=JSON.parse(a.chartStyle))}catch(d){}var g,p=angular.extend({},t,h),u=r[a.chart],f=angular.extend({},u,c);i.hasOwnProperty("echarts")&&(g="echarts");var m=o.find("div").find("div")[0],b=e.getInstance(m,a.chart,g);a.eventType&&a.eventHandler&&(b.on(a.eventType,function(e){a.eventHandler()(e)}),console.log("绑定事件成功")),p.showLoading&&b.showLoading(),a.$watch("data",function(t,r){if(t)try{var o=e.getOption(a.chart,t,f,a.tooltipFormatter,p);b.hideLoading(),b.setOption(o),a.noData=!1}catch(i){console.error(i.message),b.hideLoading(),a.noData=!0}})}}}}]).run(["$templateCache",function(e){var t=[];t.push('<div style="position: relative;height: 100%;">'),t.push('<div style="height: 100%; width: 100%;">'),t.push("</div>"),t.push('<div ng-if="noData" style="height: 100%; width: 100%; position: absolute; left: 0;top: 0;;">暂无数据</div></div>'),e.put("website-ui/chart/no-data.html",t.join(""))}]);
