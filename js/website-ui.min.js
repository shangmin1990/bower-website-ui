...
angular.module("ui.website.chart",[]).service("ChartService",[function(){var e={pline:{chart:{type:"spline",margin:[30,20,65,20]},title:{text:""},subtitle:{text:""},xAxis:{gridLineWidth:0,categories:[],lineColor:"#bababa",type:"datetime",tickmarkPlacement:"on",labels:{style:{fontSize:"14px"},y:20}},yAxis:{title:{text:"",style:{color:"#bababa",fontSize:"14px"}},lineColor:"#bababa",labels:{enabled:!1,style:{fontSize:"14px"}},plotLines:[{value:0,width:0,color:"#808080"}],tickPixelInterval:30,lineWidth:0,tickWidth:0,gridLineColor:"#efefef"},tooltip:{shared:!0,valueSuffix:"",borderWidth:1,borderColor:"#8b8b8b",useHTML:!0,crosshairs:{width:1,color:"gray",dashStyle:"shortdot"},formatter:function(){return""}},plotOptions:{line:{dataLabels:{enabled:!1},enableMouseTracking:!0,lineColor:"#47a6ff"},series:{marker:{symbol:"circle"}}},legend:{layout:"horizontal",align:"center",verticalAlign:"bottom",borderWidth:0},credits:{enabled:!1},series:[{name:"",data:[]}]}},t={line:{title:{text:""},tooltip:{trigger:"axis"},legend:{data:[]},toolbox:{show:!1},grid:{left:"3%",right:"4%",bottom:"3%",containLabel:!0},xAxis:[{type:"category",boundaryGap:!1,data:[]}],yAxis:[{type:"value"}],series:[]},bar:{title:{x:"center"},tooltip:{borderWidth:1,borderColor:"#8b8b8b",backgroundColor:"#ffffff",textStyle:{color:"#333333"},trigger:"item",formatter:"{b} : {c}%"},calculable:!1,grid:{borderWidth:0,x:"3%",y:20,y2:50,width:"94%"},xAxis:[{show:!0,type:"category",data:[],splitLine:{show:!0,lineStyle:{color:"white",width:10}},axisLabel:{show:!0,interval:"0",margin:15},axisLine:{show:!0,lineStyle:{color:"#d2d2d2",width:1}},axisTick:{onGap:null,lineStyle:{color:"#d2d2d2"}}}],yAxis:[{type:"value",show:!1}],series:[]},pie:{legend:{orient:"horizontal",y:"bottom",data:[]},tooltip:{trigger:"item",borderWidth:1,borderColor:"#8b8b8b",backgroundColor:"#ffffff",textStyle:{color:"#333333"},formatter:function(e){var t=e.name+": "+Number(e.percent).toFixed(1)+"%";return t}},calculable:!1,series:[{name:"",type:"pie",itemStyle:{normal:{label:{show:!1},labelLine:{show:!1}},emphasis:{label:{show:!0,position:"center",textStyle:{fontSize:"30",fontWeight:"bold"}}}},data:[]}]}};return{getInstance:function(r,a,o){if(a){if(t.hasOwnProperty(a))return echarts.init(r);if(e.hasOwnProperty(a))return highcharts.init(r)}else{if("echarts"==o)return echarts.init(r);if("highcharts"==o)return $(r).highcharts()}},getOption:function(e,r,a,o){if(!e)return r;var i=angular.copy(t[e]);o&&(i.tooltip.formatter=o());var l=r.data,n=r.category,s=[];if("bar"==e){for(var h=0;h<l.length;h++){for(var c=[],d=l[h],f=[],g={name:"",type:e,barWidth:30,data:[]},p=0;p<d.length;p++){var u={name:n[p],data:d[p]};f.push(u)}var b=f.concat();b.sort(function(e,t){return Number(t.data)-Number(e.data)});for(var p=0;p<b.length;p++)b[p].color=a.color[p%a.color.length];for(var p=0;p<f.length;p++){var y={value:f[p].data,name:f[p].name,itemStyle:{normal:{color:f[p].color,label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}},labelLine:{show:!1}},emphasis:{label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}}}}};c.push(y)}g.data=c,s.push(g)}return i.series=s,i.xAxis[0].data=r.category,i}if("line"==e){for(var h=0;h<l.length;h++){for(var c=[],d=l[h],f=[],g={name:"",type:e,data:[]},p=0;p<d.length;p++){var u={name:n[p],data:d[p]};f.push(u)}for(var p=0;p<f.length;p++){var y={value:f[p].data,name:f[p].name};c.push(y)}if(a&&a.color&&a.color.length>=l.length){var m={normal:{color:a.color[h]}};g.lineStyle=m}g.data=c,s.push(g)}return i.series=s,i.xAxis[0].data=r.category,i}if("pie"==e)for(var h=0;h<l.length;h++){var c=[],v=l[h];if(!v||v.length!=n.length)throw new Error("Data error, check your data please");for(var p=0;p<n.length;p++){var y={name:n[p],value:l[h][p],itemStyle:{normal:{},emphasis:{label:{show:!1}}}};a.color&&a.color.length>=n.length&&(y.itemStyle.normal.color=a.color[p]),c.push(y)}return i.series[h].data=c,i.legend.data=r.category,a&&a.center&&a.center.length>=l.length&&(i.series[h].center=a.center[h]),a&&a.radius&&a.radius.length>=l.length&&(i.series[h].radius=a.radius[h]),i}}}}]).directive("chart",["ChartService",function(e){var t={showLoading:!0,order:!0,limit:10,noDataTemplateUrl:"templates/echarts/no-data.html"},r={bar:{color:["#03a7e5","#03a7e5","#1db5ee","#1db5ee","#42ccff","#42ccff","#7ddcff","#7ddcff","#a6e7ff","#a6e7ff","#a6e7ff"],orientation:"horizontal"},pie:{}};return{restrict:"A",scope:{chart:"@",config:"@",data:"=",eventType:"@",eventHandler:"&",chartStyle:"@",tooltipFormatter:"&"},templateUrl:"website-ui/chart/no-data.html",replace:!1,compile:function(a,o){return function(a,o,i,l){var n=window.getComputedStyle(o[0]),s=n.getPropertyValue("height");"0px"==s&&o.css({height:"200px"});var h={},c={};try{a.config&&(h=JSON.parse(a.config)),a.chartStyle&&(c=JSON.parse(a.chartStyle))}catch(d){}var f,g=angular.extend({},t,h),p=r[a.chart],u=angular.extend({},p,c);i.hasOwnProperty("echarts")&&(f="echarts");var b=o.find("div").find("div")[0],y=e.getInstance(b,a.chart,f);a.eventType&&a.eventHandler&&(y.on(a.eventType,function(e){a.eventHandler()(e)}),console.log("绑定事件成功")),g.showLoading&&y.showLoading(),a.$watch("data",function(t,r){if(t)try{var o=e.getOption(a.chart,t,u,a.tooltipFormatter);y.hideLoading(),y.setOption(o),a.noData=!1}catch(i){console.error(i.message),y.hideLoading(),a.noData=!0}})}}}}]).run(["$templateCache",function(e){var t=[];t.push('<div style="position: relative;height: 100%;">'),t.push('<div style="height: 100%; width: 100%;">'),t.push("</div>"),t.push('<div ng-if="noData" style="height: 100%; width: 100%; position: absolute; left: 0;top: 0;;">暂无数据</div></div>'),e.put("website-ui/chart/no-data.html",t.join(""))}]);
