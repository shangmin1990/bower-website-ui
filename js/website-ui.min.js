...
angular.module("ui.website.chart",[]).service("ChartService",[function(){var e={pline:{chart:{type:"spline",margin:[30,20,65,20]},title:{text:""},subtitle:{text:""},xAxis:{gridLineWidth:0,categories:[],lineColor:"#bababa",type:"datetime",tickmarkPlacement:"on",labels:{style:{fontSize:"14px"},y:20}},yAxis:{title:{text:"",style:{color:"#bababa",fontSize:"14px"}},lineColor:"#bababa",labels:{enabled:!1,style:{fontSize:"14px"}},plotLines:[{value:0,width:0,color:"#808080"}],tickPixelInterval:30,lineWidth:0,tickWidth:0,gridLineColor:"#efefef"},tooltip:{shared:!0,valueSuffix:"",borderWidth:1,borderColor:"#8b8b8b",useHTML:!0,crosshairs:{width:1,color:"gray",dashStyle:"shortdot"},formatter:function(){return""}},plotOptions:{line:{dataLabels:{enabled:!1},enableMouseTracking:!0,lineColor:"#47a6ff"},series:{marker:{symbol:"circle"}}},legend:{layout:"horizontal",align:"center",verticalAlign:"bottom",borderWidth:0},credits:{enabled:!1},series:[{name:"",data:[]}]}},t={line:{title:{text:""},tooltip:{trigger:"axis"},legend:{data:[]},toolbox:{show:!1},grid:{left:"3%",right:"4%",bottom:"3%",containLabel:!0},xAxis:[{type:"category",boundaryGap:!1,data:[]}],yAxis:[{type:"value"}],series:[]},bar:{title:{x:"center"},tooltip:{borderWidth:1,borderColor:"#8b8b8b",backgroundColor:"#ffffff",textStyle:{color:"#333333"},trigger:"item",formatter:"{b} : {c}%"},calculable:!1,grid:{borderWidth:0,x:"3%",y:20,y2:50,width:"94%"},xAxis:[{show:!0,type:"category",data:[],splitLine:{show:!0,lineStyle:{color:"white",width:10}},axisLabel:{show:!0,interval:"0",margin:15},axisLine:{show:!0,lineStyle:{color:"#d2d2d2",width:1}},axisTick:{onGap:null,lineStyle:{color:"#d2d2d2"}}}],yAxis:[{type:"value",show:!1}],series:[]},pie:{legend:{orient:"horizontal",y:"bottom",data:[]},tooltip:{trigger:"item",borderWidth:1,borderColor:"#8b8b8b",backgroundColor:"#ffffff",textStyle:{color:"#333333"},formatter:function(e){var t=e.name+": "+Number(e.percent).toFixed(1)+"%";return t}},calculable:!1,series:[{name:"",type:"pie",itemStyle:{normal:{label:{show:!1},labelLine:{show:!1}},emphasis:{label:{show:!0,position:"center",textStyle:{fontSize:"30",fontWeight:"bold"}}}},data:[]}]}};return{getInstance:function(a,r,o){if(r){if(t.hasOwnProperty(r))return echarts.init(a);if(e.hasOwnProperty(r))return highcharts.init(a)}else{if("echarts"==o)return echarts.init(a);if("highcharts"==o)return $(a).highcharts()}},getOption:function(e,a,r){if(!e)return a;var o=angular.copy(t[e]),i=a.data,l=a.category,n=[],s=[];if("bar"==e){for(var c=0;c<i.length;c++){for(var h=i[c],d=[],f={name:"",type:e,barWidth:30,data:[]},p=0;p<h.length;p++){var g={name:l[p],data:h[p]};d.push(g)}var u=d.concat();u.sort(function(e,t){return Number(t.data)-Number(e.data)});for(var p=0;p<u.length;p++)u[p].color=r.color[p%r.color.length];for(var p=0;p<d.length;p++){var b={value:d[p].data,name:d[p].name,itemStyle:{normal:{color:d[p].color,label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}},labelLine:{show:!1}},emphasis:{label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}}}}};n.push(b)}f.data=n,s.push(f)}return o.series=s,o.xAxis[0].data=a.category,o}if("line"==e){for(var c=0;c<i.length;c++){for(var h=i[c],d=[],f={name:"",type:e,data:[]},p=0;p<h.length;p++){var g={name:l[p],data:h[p]};d.push(g)}for(var p=0;p<d.length;p++){var b={value:d[p].data,name:d[p].name,itemStyle:{normal:{label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}},labelLine:{show:!1}},emphasis:{label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}}}}};n.push(b)}if(r&&r.color&&r.color.length>=i.length){var y={normal:{color:r.color[c],label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}},labelLine:{show:!1}},emphasis:{label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}}}};f.itemStyle=y}f.data=n,s.push(f)}return o.series=s,o.xAxis[0].data=a.category,o}if("pie"==e)for(var c=0;c<i.length;c++){var m=i[c];if(!m||m.length!=l.length)throw new Error("Data error, check your data please");for(var p=0;p<l.length;p++){var b={name:l[p],value:i[c][p],itemStyle:{normal:{},emphasis:{label:{show:!1}}}};r.color&&r.color.length>=l.length&&(b.itemStyle.normal.color=r.color[p]),n.push(b)}return o.series[c].data=n,o.legend.data=a.category,r.center&&(o.series[c].center=r.center),r.radius&&(o.series[c].radius=r.radius),o}}}}]).directive("chart",["ChartService",function(e){var t={showLoading:!0,order:!0,limit:10,noDataTemplateUrl:"templates/echarts/no-data.html"},a={bar:{color:["#03a7e5","#03a7e5","#1db5ee","#1db5ee","#42ccff","#42ccff","#7ddcff","#7ddcff","#a6e7ff","#a6e7ff","#a6e7ff"],orientation:"horizontal"},pie:{}};return{restrict:"A",scope:{chart:"@",config:"@",data:"=",eventType:"@",eventHandler:"&",chartStyle:"@"},templateUrl:"website-ui/chart/no-data.html",replace:!1,compile:function(r,o){return function(r,o,i,l){var n=window.getComputedStyle(o[0]),s=n.getPropertyValue("height");"0px"==s&&o.css({height:"200px"});var c={},h={};try{r.config&&(c=JSON.parse(r.config)),r.chartStyle&&(h=JSON.parse(r.chartStyle))}catch(d){}var f,p=angular.extend({},t,c),g=a[r.chart],u=angular.extend({},g,h);i.hasOwnProperty("echarts")&&(f="echarts");var b=o.find("div").find("div")[0],y=e.getInstance(b,r.chart,f);r.eventType&&r.eventHandler&&(y.on(r.eventType,function(e){r.eventHandler()(e)}),console.log("绑定事件成功")),p.showLoading&&y.showLoading(),r.$watch("data",function(t,a){if(t)try{var o=e.getOption(r.chart,t,u);y.hideLoading(),y.setOption(o),r.noData=!1}catch(i){console.error(i.message),y.hideLoading(),r.noData=!0}})}}}}]).run(["$templateCache",function(e){var t=[];t.push('<div style="position: relative;height: 100%;">'),t.push('<div style="height: 100%; width: 100%;">'),t.push("</div>"),t.push('<div ng-if="noData" style="height: 100%; width: 100%; position: absolute; left: 0;top: 0;;">暂无数据</div></div>'),e.put("website-ui/chart/no-data.html",t.join(""))}]);
