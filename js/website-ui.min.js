...
angular.module("ui.website.dialog.directives",[]).directive("walert",["$timeout",function(n){return{restrict:"EA",transclude:!0,templateUrl:"template/alert.html",compile:function(t,i,l){function d(){t.children().removeClass("in"),n(function(){t.hide()},150)}return t.show(),{pre:angular.noop,post:function(t,i,l,c){i.find("div.modal-footer").find("button").unbind("click").bind("click",function(n){d()}),i.find("button.close").unbind("click").bind("click",function(n){d()}),n(function(){i.children().addClass("in")},0)}}}}}]).directive("wconfirm",["$timeout",function(n){return{restrict:"EA",transclude:!0,templateUrl:"template/confirm.html",compile:function(t,i,l){function d(){t.children().removeClass("in"),n(function(){t.hide()},150)}return t.show(),{pre:angular.noop,post:function(t,i,l,c){var o=i.find("div.modal-footer").find("button");angular.element(o[0]).unbind("click").bind("click",function(n){t.ok(),d()}),angular.element(o[1]).unbind("click").bind("click",function(n){d()}),i.find("button.close").unbind("click").bind("click",function(n){d()}),n(function(){i.children().addClass("in")},0)}}}}}]).directive("wprompt",["$timeout",function(n){return{restrict:"EA",transclude:!0,templateUrl:"template/confirm.html",compile:function(t,i,l){function d(t,i,l,d){var o=i.find("div.modal-footer").find("button");angular.element(o[0]).unbind("click").bind("click",function(n){var l=t.callback(i.find("input").val());"boolean"==typeof l&&l||1===l?c():i.find("input").parent().addClass("has-error").addClass("has-feedback")}),angular.element(o[1]).unbind("click").bind("click",function(n){c()}),i.find("button.close").unbind("click").bind("click",function(n){c()}),n(function(){i.children().addClass("in")},0)}function c(){t.children().removeClass("in"),n(function(){t.hide()},150)}return t.show(),d}}}]).run(["$templateCache",function(n){n.put("template/alert.html",'<div class="modal fade" style="display:block;"><div class="modal-dialog modal-sm"><div class="modal-content"><div class="modal-header"><div class="row"><div class="col-md-9 col-lg-9">{{title}}</div><div class="col-md-3 col-lg-3"><button type="button" class="close"><span>×</span></button></div></div></div><div class="modal-body text-center"><p><div ng-transclude></div></p></div><div class="modal-footer"><button type="button" class="btn btn-orz">确定</button></div></div></div></div><div class="modal-backdrop fade"></div>'),n.put("template/confirm.html",'<div class="modal fade" style="display:block;"><div class="modal-dialog modal-sm"><div class="modal-content"><div class="modal-header"><div class="row"><div class="col-md-9 col-lg-9">{{title}}</div><div class="col-md-3 col-lg-3"><button type="button" class="close"><span>×</span></button></div></div></div><div class="modal-body text-center"><p><div ng-transclude></div></p></div><div class="modal-footer"> <button type="button" class="btn btn-orz">是</button> <button type="button" class="btn btn-default btn-large" >否</button></div></div></div></div><div class="modal-backdrop fade"></div>')}]);
