...
angular.module("ui.website.select.directives",["ui.bootstrap.position"]).directive("wsSelect",["$compile","$document","$uibPosition","$timeout",function(e,i,t,n){return{restrict:"EA",replace:!0,templateUrl:"template/wsSelect.html",require:["ngModel"],scope:{options:"=",onSelected:"&",config:"@"},compile:function(t,o,a){return{pre:angular.noop,post:function(t,o,a,l){var c=l[0];t.config=t.config||{},t.config.displayFieldName=t.config.displayFieldName||"key",t.config.valueFieldName=t.config.valueFieldName||"value";var s=uuid(),r=angular.element("<div ws-select-container></div>");r.attr({id:s});var d=e(r)(t);o.append(d),$(o).bind("click",function(e){e.stopPropagation();var i=d.find("li");if(i){var t=o.find("div").html();i.removeClass("active"),angular.forEach(i,function(e,i){$(e).find("a").html()===t&&$(e).addClass("active")})}d.show()}),i.bind("click",function(e){d.hide()}),t.$watch("options",function(e){e&&e.length>0&&n(function(){var e=d.find("li");e.bind("click",function(i){i.stopPropagation();var n=this;e.removeClass("active"),$(n).addClass("active"),d.hide(),d.css("display","none");var a=$(n).find("a").html();o.find("div").html(a),c.$setViewValue($(n).attr("value")),t.onSelected(a,i)}),e.bind("mouseenter",function(i){var t=this;e.removeClass("active"),$(t).addClass("active")})},0)},!0)}}}}}]).directive("wsSelectContainer",[function(){return{restrict:"EA",replace:!0,templateUrl:"template/wsSelectContainer.html"}}]).run(["$templateCache",function(e){var i=[];i.push('<div class="pull-left" style="position: relative;"><div style="border-radius: 4px" class="form-control" ></div><i class="fa fa-sort" style="position: absolute;right: 5px;top: 0px;height: 100%;padding-top: 10px; transform: scaleX(0.8)"></i></div>'),e.put("template/wsSelect.html",i.join("")),e.put("template/wsSelectContainer.html",'<ul class="dropdown-menu" style=\'min-height:100px;max-width: 400px;max-height: 400px;overflow-y: scroll;box-shadow: 0 6px 12px rgba(0,0,0,.175);border: 1px solid #ccc;\'>\n    <li class="ws-select-option" value=\'{{option[config.valueFieldName]}}\' ng-repeat="option in options track by $index" ng-click="onSelected(option.value, $event)" role="option" >\n        <a >{{option[config.displayFieldName]}}</a>    </li>\n</ul>\n')}]);
