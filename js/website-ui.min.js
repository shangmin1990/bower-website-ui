...
angular.module("ui.website.dialog.directives",[]).directive("walert",["$timeout",function(t){return{restrict:"EA",transclude:!0,templateUrl:"partial/alert.html",compile:function(i,d,l){function n(){i.children().removeClass("in"),t(function(){i.hide()},150)}return i.show(),{pre:angular.noop,post:function(i,d,l,o){d.find("div.modal-footer").find("button").unbind("click").bind("click",function(t){n()}),d.find("button.close").unbind("click").bind("click",function(t){n()}),t(function(){d.children().addClass("in")},0)}}}}}]).directive("wconfirm",["$timeout",function(t){return{restrict:"EA",transclude:!0,templateUrl:"partial/confirm.html",compile:function(i,d,l){function n(){i.children().removeClass("in"),t(function(){i.hide()},150)}return i.show(),{pre:angular.noop,post:function(i,d,l,o){var c=d.find("div.modal-footer").find("button");angular.element(c[0]).unbind("click").bind("click",function(t){i.ok(),n()}),angular.element(c[1]).unbind("click").bind("click",function(t){n()}),d.find("button.close").unbind("click").bind("click",function(t){n()}),t(function(){d.children().addClass("in")},0)}}}}}]).directive("wprompt",function(){return{restrict:"EA",transclude:!0,templateUrl:"templates/alert.html",link:function(t,i,d,l){i.find("div.modal-footer").find("button").unbind("click").bind("click",function(t){i.hide()}),i.find("button.close").unbind("click").bind("click",function(t){i.hide()})}}}).run(["$templateCache",function(t){t.put("template/alert.html",'<div class="modal fade" style="display:block;"><div class="modal-dialog modal-sm"><div class="modal-content"><div class="modal-header"><div class="row"><div class="col-md-9 col-lg-9">{{title}}</div><div class="col-md-3 col-lg-3"><button type="button" class="close"><span>×</span></button></div></div></div><div class="modal-body text-center"><p><div ng-transclude></div></p></div><div class="modal-footer"><button type="button" class="btn btn-orz">确定</button></div></div></div></div><div class="modal-backdrop fade"></div>'),t.put("template/confirm.html",'<div class="modal fade" style="display:block;"><div class="modal-dialog modal-sm"><div class="modal-content"><div class="modal-header"><div class="row"><div class="col-md-9 col-lg-9">{{title}}</div><div class="col-md-3 col-lg-3"><button type="button" class="close"><span>×</span></button></div></div></div><div class="modal-body text-center"><p><div ng-transclude></div></p></div><div class="modal-footer"> <button type="button" class="btn btn-orz">是</button> <button type="button" class="btn btn-default btn-large" >否</button></div></div></div></div><div class="modal-backdrop fade"></div>'),t.put("template/prompt.html",'<div class="modal fade" style="display:block;"><div class="modal-dialog modal-sm"><div class="modal-content"><div class="modal-header"><div class="row"><div class="col-md-9 col-lg-9">{{title}}</div><div class="col-md-3 col-lg-3"><button type="button" class="close"><span>×</span></button></div></div></div><div class="modal-body text-center"><p><div ng-transclude></div></p></div><div class="modal-footer"> <button type="button" class="btn btn-orz">是</button> <button type="button" class="btn btn-default btn-large" >否</button></div></div></div></div><div class="modal-backdrop fade"></div>')}]);
angular.module("ui.website.dialog.service",[]).factory("DialogService",["$document","$compile","$rootScope",function(e,n,t){return{alert:function(i,r){var a=e.find("walert");0==a.length?(a=angular.element('<walert title="'+r+'">'+i+"</walert>"),e.find("body").append(a)):a.html(i);var l=t.$new(!1);r||(r="警告"),l.title=r,n(a)(l)},confirm:function(i,r,a){var l=e.find("wconfirm");0==l.length?(l=angular.element('<wconfirm title="'+a+'" >'+i+"</wconfirm>"),e.find("body").append(l)):(l.html(i),l.data("success",r));var o=t.$new(!1);a||(a="请确认"),o.title=a,o.ok=r,n(l)(o)},prompt:function(){}}}]);
