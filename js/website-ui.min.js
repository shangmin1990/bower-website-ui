...
angular.module("ui.website.chart",[]).service("ChartService",[function(){var t={pline:{chart:{type:"spline",margin:[30,20,65,20]},title:{text:""},subtitle:{text:""},xAxis:{gridLineWidth:0,categories:[],lineColor:"#bababa",type:"datetime",tickmarkPlacement:"on",labels:{style:{fontSize:"14px"},y:20}},yAxis:{title:{text:"",style:{color:"#bababa",fontSize:"14px"}},lineColor:"#bababa",labels:{enabled:!1,style:{fontSize:"14px"}},plotLines:[{value:0,width:0,color:"#808080"}],tickPixelInterval:30,lineWidth:0,tickWidth:0,gridLineColor:"#efefef"},tooltip:{shared:!0,valueSuffix:"",borderWidth:1,borderColor:"#8b8b8b",useHTML:!0,crosshairs:{width:1,color:"gray",dashStyle:"shortdot"},formatter:function(){return""}},plotOptions:{line:{dataLabels:{enabled:!1},enableMouseTracking:!0,lineColor:"#47a6ff"},series:{marker:{symbol:"circle"}}},legend:{layout:"horizontal",align:"center",verticalAlign:"bottom",borderWidth:0},credits:{enabled:!1},series:[{name:"",data:[]}]}},e={line:{title:{text:""},tooltip:{trigger:"axis"},legend:{data:[]},toolbox:{show:!1},grid:{left:"3%",right:"4%",bottom:"3%",containLabel:!0},xAxis:[{type:"category",boundaryGap:!1,data:[]}],yAxis:[{type:"value"}],series:[]},bar:{title:{x:"center"},tooltip:{borderWidth:1,borderColor:"#8b8b8b",backgroundColor:"#ffffff",textStyle:{color:"#333333"},trigger:"item",formatter:"{b} : {c}%"},calculable:!1,grid:{borderWidth:0,x:"3%",y:20,y2:50,width:"94%"},xAxis:[{show:!0,type:"category",data:[],splitLine:{show:!0,lineStyle:{color:"white",width:10}},axisLabel:{show:!0,interval:"0",margin:15},axisLine:{show:!0,lineStyle:{color:"#d2d2d2",width:1}},axisTick:{onGap:null,lineStyle:{color:"#d2d2d2"}}}],yAxis:[{type:"value",show:!1}],series:[]},pie:{legend:{orient:"horizontal",y:"bottom",data:[]},tooltip:{trigger:"item",borderWidth:1,borderColor:"#8b8b8b",backgroundColor:"#ffffff",textStyle:{color:"#333333"},formatter:function(t){var e=t.name+": "+Number(t.percent).toFixed(1)+"%";return e}},calculable:!1,series:[{name:"",type:"pie",itemStyle:{normal:{label:{show:!1},labelLine:{show:!1}},emphasis:{label:{show:!0,position:"center",textStyle:{fontSize:"30",fontWeight:"bold"}}}},data:[]}]}};return{getInstance:function(a,r,i){if(r){if(e.hasOwnProperty(r))return echarts.init(a);if(t.hasOwnProperty(r))return highcharts.init(a)}else{if("echarts"==i)return echarts.init(a);if("highcharts"==i)return $(a).highcharts()}},getOption:function(t,a,r,i,o){if(!t)return a;var l=angular.copy(e[t]);i()&&(l.tooltip.formatter=i());var n=a.data,s=a.category;o.limit>0&&s.length>o.limit&&(s=s.slice(0,o.limit));var c=[];if("bar"==t){for(var h=0;h<n.length;h++){var d=[],g=n[h],y=[],u={name:"",type:t,barWidth:30,data:[]};o.limit>0&&s.length>o.limit&&(g=g.slice(0,o.limit));for(var p=0;p<g.length;p++){var b={name:s[p],data:g[p]};y.push(b)}var m=o&&o.sortForColor,M=r&&r.color&&r.color.length>=n.length&&r.color[0].length>=g.length;if(m&&M){var w=y.concat();w.sort(function(t,e){return Number(e.data)-Number(t.data)});for(var p=0;p<w.length;p++)w[p].color=r.color[h][p]}for(var p=0;p<y.length;p++){var f={value:y[p].data,name:y[p].name,itemStyle:{normal:{label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}},labelLine:{show:!1}},emphasis:{label:{show:!0,position:"top",formatter:"{c}%",textStyle:{color:"#37a3fd"}}}}};y[p].color&&(f.itemStyle.normal.color=y[p].color),d.push(f)}u.data=d,c.push(u)}if(l.series=c,l.xAxis[0].data=a.category,"vertical"===r.orientation){var x=l.yAxis;l.yAxis=xAxis,l.xAxis=x}return l}if("line"==t){for(var h=0;h<n.length;h++){for(var d=[],g=n[h],y=[],u={name:"",type:t,data:[]},p=0;p<g.length;p++){var b={name:s[p],data:g[p]};y.push(b)}for(var p=0;p<y.length;p++){var f={value:y[p].data,name:y[p].name};d.push(f)}if(r&&r.color&&r.color.length>=n.length){var v={normal:{color:r.color[h]}};u.lineStyle=v}u.data=d,c.push(u)}return l.series=c,l.xAxis[0].data=a.category,l}if("pie"==t)for(var h=0;h<n.length;h++){var d=[],I=n[h];if(!I||I.length!=s.length)throw new Error("Data error, check your data please");for(var p=0;p<s.length;p++){var f={name:s[p],value:n[h][p],itemStyle:{normal:{},emphasis:{label:{show:!1}}}};r.color&&r.color.length>=n.length&&r.color[0].length>=s.length&&(f.itemStyle.normal.color=r.color[h][p]),d.push(f)}return l.series[h].data=d,l.legend.data=a.category,r&&r.center&&r.center.length>=n.length&&(l.series[h].center=r.center[h]),r&&r.radius&&r.radius.length>=n.length&&(l.series[h].radius=r.radius[h]),l}}}}]).directive("chart",["ChartService",function(t){var e={showLoading:!0,sortForColor:!1,limit:-1,noDataTemplateUrl:"templates/echarts/no-data.html"},a={bar:{orientation:"horizontal"},pie:{}};return{restrict:"A",scope:{chart:"@",config:"@",chartData:"=data",eventType:"@",eventHandler:"&",chartStyle:"@",tooltipFormatter:"&"},templateUrl:"website-ui/chart/no-data.html",replace:!1,compile:function(r,i){return function(r,i,o,l){var n=window.getComputedStyle(i[0]),s=n.getPropertyValue("height");"0px"==s&&i.css({height:"200px"});var c={},h={};try{r.config&&(c=JSON.parse(r.config)),r.chartStyle&&(h=JSON.parse(r.chartStyle))}catch(d){}var g,y=angular.extend({},e,c),u=a[r.chart],p=angular.extend({},u,h);o.hasOwnProperty("echarts")&&(g="echarts");var b=i.find("div").find("div")[0],m=t.getInstance(b,r.chart,g);r.eventType&&r.eventHandler&&(m.on(r.eventType,function(t){r.eventHandler()(t)}),console.log("绑定事件成功")),y.showLoading&&m.showLoading(),r.$watch("chartData",function(e,a){if(void 0!==e)try{var i=t.getOption(r.chart,e,p,r.tooltipFormatter,y);m.hideLoading(),m.setOption(i),r.noData=!1}catch(o){console.error(o.message),m.hideLoading(),r.noData=!0}})}}}}]).run(["$templateCache",function(t){var e=[];e.push('<div style="position: relative;height: 100%;">'),e.push('<div style="height: 100%; width: 100%;"></div>'),e.push('<div id="nodata_container" ng-if="noData" style="height: 100%; width: 100%; position: absolute; left: 0;top: 0;display: flex;align-items: center;justify-content: center">'),e.push('<div><img src="data:image/svg+xml;base64," height="80" width="80"/> <p style="margin-top: 10px;text-align:center">暂无数据</p></div>'),e.push("</div>"),t.put("website-ui/chart/no-data.html",e.join(""))}]);
